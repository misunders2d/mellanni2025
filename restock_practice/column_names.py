sales_columns = [
    ...
    "title",
    "sku",
    "sessions_-_mobile_app",
    "sessions_-_mobile_app_-_b2b",
    "sessions_-_browser",
    "sessions_-_browser_-_b2b",
    "sessions_-_total",
    "sessions_-_total_-_b2b",
    "session_percentage_-_mobile_app",
    "session_percentage_-_mobile_app_-_b2b",
    "session_percentage_-_browser",
    "session_percentage_-_browser_-_b2b",
    "session_percentage_-_total",
    "session_percentage_-_total_-_b2b",
    "page_views_-_mobile_app",
    "page_views_-_mobile_app_-_b2b",
    "page_views_-_browser",
    "page_views_-_browser_-_b2b",
    "page_views_-_total",
    "page_views_-_total_-_b2b",
    "page_views_percentage_-_mobile_app",
    "page_views_percentage_-_mobile_app_-_b2b",
    "page_views_percentage_-_browser",
    "page_views_percentage_-_browser_-_b2b",
    "page_views_percentage_-_total",
    "page_views_percentage_-_total_-_b2b",
    "featured_offer_(buy_box)_percentage",
    "featured_offer_(buy_box)_percentage_-_b2b",
    "units_ordered",
    "units_ordered_-_b2b",
    "units_session_percentage",
    "ordered_product_sales",
    "ordered_product_sales_-_b2b",
    "total_order_items",
    "total_order_items_-_b2b",
    "date",
    "units_session_percentage_-_b2b",
]


fba_inventory_columns = [
    "snapshot-date",
    "sku",
    "fnsku",
    "asin",
    ...
    "recommended_ship-in_quantity",
    "recommended_ship-in_date",
