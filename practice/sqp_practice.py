...
immutable_cols = ['Search Query Volume',
...
result = pd.merge(total_data, asin_data, how = 'outer', on = 'Search Query', validate='one_to_one')
result.to_excel('/home/misunderstood/temp/result.xlsx', index=False) # change output path