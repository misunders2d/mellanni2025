...
total_df["clicksXprice"] = (
    total_df["Clicks: ASIN Count"] * total_df["Clicks: ASIN Price (Median)"]
)
total_df["atcXprice"] = (
    total_df["Cart Adds: ASIN Count"] * total_df["Cart Adds: ASIN Price (Median)"]
)
total_df["purchaseXprice"] = (
    total_df["Purchases: ASIN Count"] * total_df["Purchases: ASIN Price (Median)"]
)
...
alt_df["Clicks: ASIN Price (Median)"] = (
    alt_df["clicksXprice"] / alt_df["Clicks: ASIN Count"]
)
alt_df["Cart Adds: ASIN Price (Median)"] = (
    alt_df["atcXprice"] / alt_df["Cart Adds: ASIN Count"]
)
alt_df["Purchases: ASIN Price (Median)"] = (
    alt_df["purchaseXprice"] / alt_df["Purchases: ASIN Count"]
)
# end of alternative method


result = pd.merge(asin_df, others_df, how="outer", on="Search Query", validate="1:1")
result["Clicks: ASIN Price (Median)"] = (
    result["clicksXprice"] / result["Clicks: ASIN Count"]
)
result["Cart Adds: ASIN Price (Median)"] = (
    result["atcXprice"] / result["Cart Adds: ASIN Count"]
)
result["Purchases: ASIN Price (Median)"] = (
    result["purchaseXprice"] / result["Purchases: ASIN Count"]
)
...
with pd.ExcelWriter(
    "/home/misunderstood/temp/sqp_result.xlsx", engine="xlsxwriter"
) as writer:
